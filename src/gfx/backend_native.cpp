...
// queries via NativeContextWindow below); an anonymous-namespace type
// can't be named from another translation unit.
...
GLFWwindow *NativeContextWindow(NativeContext *ctx) { return ctx->window; }
...
public:
    ...
    void SetClipboardText(const std::string &text) override {
        glfwSetClipboardString(ctx_->window, text.c_str());
    }
